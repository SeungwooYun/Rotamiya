const ServicesExhibition = () => {
    return <div id="Exhibition-Management">
        ...
        <h3>CES Exhibition. December 2021. LA. USA.</h3>
        ...
        <div className="images-div">
            ...
            <img className="productsImage" src="images/exhibition/ex_usa_3.jpg" alt="USA exhibition"></img>
            <img className="productsImage" src="images/exhibition/ex_usa_4.jpg" alt="USA exhibition"></img>
        </div>

        <h3>Exhibition in Gwangju. March 2022. South Korea.</h3>
        <div className="images-div">
        ...
        <h3>Arab Health. January 2022. Dubai. UAE.</h3>
        <div className="images-div">
            ...
            <img className="productsImage" src="images/exhibition/ex_uae_3.png" alt="UAE exhibition"></img>
        </div>

        <h3>Cosmobeauty Expo. May 2022. Seoul, South Korea.</h3>
        ...
        <div className="images-div">
            ...
            <img className="productsImage" src="images/exhibition/ex_seoul_1.png" alt="Seoul exhibition"></img>
        </div>
        <h3>InterCharm Korea, September 2022. Seoul South Korea.</h3>
        <div className="images-div">
            ...
            <img className="productsImage" src="images/exhibition/ex_interCharm_1.png" alt="Seoul_interCharm exhibition"></img>
        </div>

        <h3>Gwangju Tea Exhibition. October 2022. Gwangju, South Korea.</h3>
        <div className="images-div">
            ...
            <img className="productsImage" src="images/exhibition/ex_Gwangju_3.jpg" alt="Gwangju Tea exhibition"></img>
        </div>
    </div>
}
